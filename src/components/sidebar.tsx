...
import { BookOpen, BoxSelect, Check, Search } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <SidebarMenu className="space-y-2">
              <SidebarMenuItem>
                ...
                <SidebarMenuButton
                  onClick={() => setCategory("")}
                  className={`w-full justify-start px-4 py-3 rounded-lg border-2 transition-all duration-200 shadow-sm hover:shadow-md group flex items-center
                    ${category === "" 
                      ? "bg-indigo-100 border-indigo-400 text-indigo-900" 
                      : "bg-white hover:bg-indigo-50 border-indigo-200 hover:border-indigo-300 text-indigo-800 hover:text-indigo-900"
                    }`}
                >
                  {category === "" ? (
